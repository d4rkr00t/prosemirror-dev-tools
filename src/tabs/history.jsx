...
export default function HistoryView({ rollbackHistory }) {
    ...
    <SplitView>
      <SplitViewCol noPaddings minWidth={190}>
        <List
          ...
          onListItemClick={(item) => setSelectedHistoryItem(item.index)}
          onListItemDoubleClick={(item) => rollbackHistory(item, item.index)}
        />
      </SplitViewCol>
